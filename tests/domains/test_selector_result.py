...
def dict_selector_result1():
    return {'name': [(SelectorResultColumnType.SELECT, 1),  # type and strategy weight
...
def dict_selector_result2():
    return {'date': ['2022-01-01', '2022-01-02', '2022-01-03', '2022-01-04', '2022-01-05'],
            'strategy1': [(SelectorResultColumnType.SELECT, 100),
...
def test_init_strategy_result_from_dict(dict_selector_result2):
    selector_result = SelectorResult.from_dict(
